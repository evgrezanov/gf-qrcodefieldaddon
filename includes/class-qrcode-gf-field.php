...
class QRcode_GF_Field extends GF_Field {

	/**
	 * @var string $type The field type.
	 */
	public $type = 'gfqrcode';
	...
	public function get_form_editor_inline_script_on_page_render() {
		...
		$script = sprintf( "function SetDefaultValues_qrcode(field) {field.label = '%s';}", $this->get_form_editor_field_title() ) . PHP_EOL;
...
GF_Fields::register( new QRcode_GF_Field() );
